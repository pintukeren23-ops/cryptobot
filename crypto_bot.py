...
def ai_analisis(token_info):
    try:
        prompt = (
            ...
            "STATUS KEAMANAN: (Aman/Waspada/Bahaya)\n"
            "POTENSI PUMP: (Rendah/Sedang/Tinggi)\n\n"
            "SARAN ENTRY:\n"
            "(Jelaskan kondisi atau harga kapan sebaiknya entry, atau bilang jangan entry kalau terlalu berisiko)\n\n"
            "TARGET PROFIT (TP):\n"
            "(Berikan persentase target misal +20%, +50%, atau +100% berdasarkan momentum saat ini)\n\n"
            "STOP LOSS (SL):\n"
            "(Berikan persentase batas rugi misal -15% atau -20% untuk cut loss)\n\n"
            "ALASAN:\n"
            "(Jelaskan 2-3 kalimat kenapa kasih rekomendasi tersebut berdasarkan data liquidity, volume, dan price action)\n\n"
            "Jawab dalam Bahasa Indonesia, singkat dan actionable. Jangan bertele-tele."
        )
