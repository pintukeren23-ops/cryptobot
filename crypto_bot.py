...
def ai_analisis(token_info, harga):
    try:
        ...
        prompt = (
            ...
            "- tp1_harga & tp2_harga: prediksi harga dalam USD berdasarkan analisis momentum, volume, dan liquidity. Bukan sekadar persentase — ini prediksi harga riil yang menurutmu realistis dicapai\n"
